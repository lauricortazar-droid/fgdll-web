...
const programs = [
  { code: "DPL1", year: "2022", title: "Diplomado en Liderazgo I", text: "Cuadernillo de apadrinamiento y videos oficiales de la generación 2022.", active: true },
