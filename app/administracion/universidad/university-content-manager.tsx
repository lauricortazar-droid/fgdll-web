...
export function UniversityContentManager({ content, reload }: { content: ContentData; reload: () => Promise<void> }) {
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    try { await fetch("/api/admin/university", { method: "PUT", headers: { "content-type": "application/json" }, body: JSON.stringify(body) }).then(parse); setMessage("Contenido guardado y listo para publicarse en Universidad."); if (kind !== "settings") setDraft({}); await reload(); }
