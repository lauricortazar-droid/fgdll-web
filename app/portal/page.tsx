...
const tools = [
  ...
  { n: "09", title: "Portal del líder", text: "Accesos, reportes, lonas, padrinos y coordinación de grupo.", tag: "Gestión", href: "/lider" },
